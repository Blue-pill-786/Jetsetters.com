    ...
    return (
        <div className=''>
            <div className='haz-hero min-h-[calc(100vh-60px)] h-full w-[100%] md:pl-10 md:px-0 sm:px-5 px-3 overflow-hidden'>
                <div className='w-full h-full flex flex-col items-center justify-center lg:mt-[10rem] mt-[10rem] md:mt-[4rem]'>
                    <h1 className='lg:text-7xl md:text-6xl text-4xl text-[#fff] font-content font-bold drop-shadow-md shadow-[#000]'>Hajj & Umrah Packages 2024</h1>
                    <p className='sm:text-xl text-pretty text-lg md:px-2 -mt-1 text-[#fff] font-content font-medium drop-shadow-md shadow-[#000]'>Browse our Special Hajj Packages designed to suit your budget!</p>
                </div>
            </div>
            ...
            <div className='sm:w-[calc(100%-10%)] sm:mx-auto my-10 sm:p-0 p-4'>
                ...
                <div className='mt-[5rem]'>
                    ...
                    <div className='flex flex-col items-center gap-y-8 md:w-[100%] lg:w-[100%] xl:w-fit md:mx-auto md:gap-y-2 md:p-2 md:bg-[#6192d655] md:rounded-[15px]'>
                        <HazCard
                            img={HazImg1}
                            zamWater={false}
                            historical={false}
