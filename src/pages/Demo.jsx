...
const Demo = () => {
    ...
    return (
        <>
            <div>
                <div className='lg:min-h-screen w-[100%] bg-hero-image bg-no-repeat lg:bg-cover bg-auto bg-center object-fill md:pl-10 md:px-0 sm:px-5 px-3 overflow-hidden'>
