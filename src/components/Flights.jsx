    ...
    return (
        <div className='bg-[#ffffff]'>
            <div className='sm:w-[calc(100%-10%)] mx-2 sm:mx-auto mt-10'>
                <h1 className='text-3xl sm:text-4xl lg:text-5xl font-bold text-neutral-700'>Search cheapest fares across these favourite destinations across the words</h1>
