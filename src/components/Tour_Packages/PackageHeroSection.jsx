...
const PackageHeroSection = ({packageClass,headColor="text-[#FFFFFF]",subHeadColor="text-[#ffffffdc]", subHeadText, headText}) => {
    return (
        <div className={`${packageClass} md:min-h-[calc(100vh-15vh)] min-h-[calc(100vh-12vh)]  h-full w-[100%] md:pl-10 md:px-0 sm:px-5 px-3 overflow-hidden`}>
            <div className='w-full h-full flex flex-col justify-center lg:mt-[5rem] mt-[10rem] md:mt-[4rem] sm:px-10 py-[5rem] lg:py-[3rem]'>
                <h1 className={`${headColor} 2xl:text-[86px] 2xl:leading-[80px] lg:text-7xl lg:leading-[65px] sm:leading-[56px] sm:text-6xl text-5xl leading-[48px] font-content font-bold drop-shadow-md shadow-black up-animate-head lg:w-[95%]`}>{headText}</h1>
